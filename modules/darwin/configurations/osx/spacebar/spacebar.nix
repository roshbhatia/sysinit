...
in
{
  services.spacebar = {
    ...
    config = {
      ...
      battery_icon_color = toSpacebarColor semanticColors.semantic.error;
      dnd_icon_color = toSpacebarColor semanticColors.foreground.muted;
      clock_icon_color = toSpacebarColor semanticColors.accent.primary;
