  ...
  return {
    {
      ...
      { "<leader>ti", "<cmd>Install Missing Themes<CR>", desc = "Install Missing Themes" },
      ...
      { "<leader>tr", "<cmd>Reload Themes<CR>", desc = "Reload Themes" },
      { "<leader>tt", "<cmd>Themify<CR>", desc = "Theme Switcher" }, -- Chose theme switcher over terminal
