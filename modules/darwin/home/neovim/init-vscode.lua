...
local function setup_vscode_features()
    ...
    local keybindings = {
        ...
        u = {
            ...
            bindings = {{
                key = "a",
                description = "Activity Bar",
                action = "workbench.action.toggleActivityBarVisibility"
            }, {
                key = "s",
                description = "Status Bar",
                action = "workbench.action.toggleStatusbarVisibility"
            }, {
                key = "t",
                description = "Tab Bar",
                action = "workbench.action.toggleTabsVisibility"
            }, {
                key = "b",
                ...
                action = "workbench.action.toggleFullScreen"
            }}
        },
        b = {
            name = " Buffer",
        ...
        g = {
            ...
            bindings = {{
                ...
                key = "d",
                description = "Open Change",
                action = "git.openChange"
            }, {
                key = "D",
                description = "Open All Changes",
                action = "git.openAllChanges"
            }, {
                key = "b",
                ...
                action = "git.revertChange"
            }, {
                key = "v",
                description = "SCM View",
            ...
            {
                key = "h",
                description = "Stage Selected Ranges",
                ...
                key = "l",
                description = "Unstage Selected Ranges",
        ...
        t = {
            ...
            bindings = {{
                ...
                action = "workbench.action.focusActiveEditorGroup"
            }, {
                key = "m",
        ...
        a = {
            ...
            bindings = {{
                ...
                action = "inlineChat.viewInChat"
            }, {
                key = "r",
                description = "Regenerate",
                action = "inlineChat.regenerate"
            }, {
                key = "a",
    ...
    local which_key = (function()
        ...
        local function write_prompt(title, placeholder, items)
            local lines = {'# Which Key Prompt', '', '**Title**: ' .. title, '', '**Placeholder**: ' .. placeholder, '',
                           'Items:', ''}
            for _, item in ipairs(items) do
                if item.kind == -1 then
                    table.insert(lines, '- --- separator ---')
                else
                    table.insert(lines, string.format('- `%s`: %s (action: %s)', item.label, item.description or '',
                        item.action or ''))
                end
            end
