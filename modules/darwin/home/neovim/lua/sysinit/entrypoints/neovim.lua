...
function Entrypoint.get_plugins()
    ...
    require("sysinit.plugins.ui.tab"), require("sysinit.plugins.ui.theme"), require("sysinit.plugins.ui.transparent"),

    -- Editor enhancements
    require("sysinit.plugins.editor.hop"), require("sysinit.plugins.keymaps"),
    require("sysinit.plugins.editor.comment"), require("sysinit.plugins.editor.commentstring"),
    require("sysinit.plugins.editor.formatter"), require("sysinit.plugins.editor.ibl"), -- File handling
