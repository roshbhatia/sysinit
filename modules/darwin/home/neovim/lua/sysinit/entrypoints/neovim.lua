...
function Entrypoint.get_plugins()
    return {require("sysinit.plugins.ui.cmdline"), require("sysinit.plugins.ui.notifications"),
            ...
            require("sysinit.plugins.ui.transparent"), require("sysinit.plugins.ui.terminal"),
            ...
            require("sysinit.plugins.ui.dressing"), require("sysinit.plugins.file.tree"),
            ...
            require("sysinit.plugins.intellicode.copilot-chat"), require("sysinit.plugins.intellicode.schemastore"),
