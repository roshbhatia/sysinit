...
function Entrypoint.get_plugins()
    return {require("sysinit.plugins.ui.alpha"), require("sysinit.plugins.ui.devicons"),
            ...
            require("sysinit.plugins.keymaps.hop"), require("sysinit.plugins.keymaps.pallete"),
            ...
            require("sysinit.plugins.git.client"), require("sysinit.plugins.git.fugitive"),
            require("sysinit.plugins.git.signs"), require("sysinit.plugins.intellicode.avante"),
            require("sysinit.plugins.intellicode.copilot"), require("sysinit.plugins.intellicode.guess-indent"),
            require("sysinit.plugins.intellicode.img-clip"), require("sysinit.plugins.intellicode.linters"),
            require("sysinit.plugins.intellicode.lsp-zero"), require("sysinit.plugins.intellicode.mason-lspconfig"),
            require("sysinit.plugins.intellicode.nvim-lspconfig"), require("sysinit.plugins.intellicode.mason"),
            require("sysinit.plugins.intellicode.nvim-autopairs"), require("sysinit.plugins.intellicode.nvim-cmp"),
            require("sysinit.plugins.intellicode.outline"), require("sysinit.plugins.intellicode.render-markdown"),
