...
M.plugins = {
	{
		...
		cmd = "Aider",
		keys = {
			{ "<leader>aii", "<cmd>Aider toggle<cr>", desc = "Copilot: Toggle chat" },
			{ "<leader>ais", "<cmd>Aider send<cr>", desc = "Copilot: Send to chat", mode = { "n", "v" } },
			{ "<leader>aic", "<cmd>Aider command<cr>", desc = "Copilot: Chat commands" },
			{ "<leader>aib", "<cmd>Aider buffer<cr>", desc = "Copilot: Send buffer" },
			{ "<leader>aid", "<cmd>Aider add<cr>", desc = "Copilot: Add file" },
			{ "<leader>air", "<cmd>Aider drop<cr>", desc = "Copilot: Drop file" },
			{ "<leader>aiR", "<cmd>Aider reset<cr>", desc = "Copilot: Reset session" },
		},
		dependencies = {
			"folke/snacks.nvim",
			"catppuccin/nvim",
