''
  ...
  This skill creates a change with artifacts:
  ...
  **Steps**
  ...
  4. **Create artifacts in sequence until apply-ready**
     ...
     Use a task tracker (TaskCreate/TaskUpdate) to track progress through artifacts.
  ...
  **Artifact Creation Guidelines**
  ...
  - `context` and `rules` are constraints for the agent, not content for the file
