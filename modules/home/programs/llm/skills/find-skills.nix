''
  ...
  This skill helps the agent discover and install skills from the open agent skills ecosystem.
  ...
  **Browse skills at:** https://skills.sh/
  ...
  If the leaderboard does not cover the user's need, run the find command:
  ...
  ```
  I searched for skills related to "xyz" but did not find any matches.
