-- flatten.nvim - Open files from terminal without nested sessions
--
-- This plugin prevents nested Neovim instances when opening files from :term,
-- Wezterm, Kitty, etc. Files are opened in the parent/host instance instead.
--
-- Features:
-- - Open files from terminal buffers without nesting
-- - Block for git commits (wait for editor to close)
-- - Pipe from terminal into Neovim buffer
-- - Command passthrough from guest to host
-- - Wezterm/Kitty integration
