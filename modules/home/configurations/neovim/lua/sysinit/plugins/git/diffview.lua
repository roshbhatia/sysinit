      ...
      require("diffview").setup({
        ...
        view = {
          ...
          default = {
            ...
            winbar_info = true, -- Show file info in window bar
          },
          merge_tool = {
        ...
        file_panel = {
          ...
          tree_options = {
            flatten_dirs = true, -- Flatten single child dirs
        ...
        hooks = {
          ...
          diff_buf_win_enter = function(bufnr, winid, ctx)
            -- Highlight 'DiffChange' as 'DiffAdd' on the local side of a 3-way diff
        ...
        keymaps = {
          ...
          view = {
            ...
            { "n", "[x", actions.prev_conflict, { desc = "In a merge conflict, jump to the previous conflict" } },
            { "n", "]x", actions.next_conflict, { desc = "In a merge conflict, jump to the next conflict" } },
            {
              "n",
              "<leader>go",
