...
M.plugins = {
  {
    enabled = agents_config.agents.enabled and agents_config.agents.avante.enabled,
    "yetone/avante.nvim",
    event = "VeryLazy",
    version = false,
    dependencies = {
    ...
    config = function()
      ...
      avante.setup({
        provider = agents_config.agents.avante.provider,
        mode = "legacy",
        providers = agents_config.agents.avante.providers,
        behaviour = {
