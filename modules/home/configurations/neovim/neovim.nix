...

{
  ...
  xdg.configFile."nvim/assets/wall.png".source =
    config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/github/personal/roshbhatia/sysinit/modules/home/configurations/neovim/assets/wall.png";
