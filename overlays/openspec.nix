...
let
  ...
  pnpmLock = final.fetchurl {
    ...
    hash = "sha256-g6JP/bYRmUUcgOs7/LqauqmEv2c+6IxxfHuA6yUjjdc="; # autoupdate:pnpm-lock-hash
  };
  ...
  pnpmDeps = final.fetchPnpmDeps {
    ...
    src = final.fetchurl {
      ...
      hash = "sha256-Ks7alGk/HbCw0uo8dQoqQYc36rMNAm0dBmYplFzemLo="; # autoupdate:src-hash
    };
    sourceRoot = "package";
    prePatch = "cp ${pnpmLock} pnpm-lock.yaml";
    fetcherVersion = 3;
    hash = "sha256-q0ohsTq60CaQtMm8Qjx2aFvV/6LOn9Hr2ijLUDQY0MM="; # autoupdate:pnpm-deps-hash
  };
in
{
