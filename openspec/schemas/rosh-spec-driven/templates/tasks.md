## 1. <!-- Loop-shaped slice: gather, act, verify, repeat to a stop condition -->
...
- [ ] 1.4 Adversarial review (`adversarial-review` skill): critics attempt to break this slice against its spec scenarios, the design decisions, and the rollout gates

## 2. <!-- Graph-shaped slice: subtasks with dependency edges -->

- **SHAPE** graph

- [ ] 2.1 <!-- root subtask --> `deps:` none
- [ ] 2.2 <!-- depends on 2.1 --> `deps:` 2.1
- [ ] 2.3 Adversarial review (`adversarial-review` skill): critics attempt to break this slice against its spec scenarios, the design decisions, and the rollout gates `deps:` 2.2

## 3. Rollout

<!-- A Rollout slice is exempt from the shape and adversarial-review rules. It
