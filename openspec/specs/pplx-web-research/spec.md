# pplx-web-research Specification

## Purpose
Install the Perplexity CLI and route external web research to it when authenticated, falling back to WebSearch otherwise, and never sending internal content to pplx.
